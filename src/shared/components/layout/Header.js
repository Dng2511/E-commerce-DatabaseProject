      ...
      <nav className="header__navbar hide-on-mobile-tablet">
              ...
              <ul className="header__notify-list">
                <li className="header__notify-item header__notify-item--viewed">
                  <a href className="header__notify-link">
                    <img src="https://placeimg.com/200/120/tech" alt="" className="header__notify-img" />
                    <div className="header__notify-info">
                      <span className="header__notify-name">Mỹ phẩm Ohui chính hãng</span>
                      <span className="header__notify-description">Mô tả mỹ phẩm Ohui chính hãng</span>
                    </div>
                  </a>
                </li>
                <li className="header__notify-item">
                  <a href className="header__notify-link">
                    <img src="https://placeimg.com/200/120/tech" alt="" className="header__notify-img" />
                    <div className="header__notify-info">
                      <span className="header__notify-name">Xác thực chính hãng nguồn gốc các sản phẩm
                        Ohui</span>
                      <span className="header__notify-description">Xác thực chính hãng nguồn gốc các sản phẩm
                        Ohui</span>
                    </div>
                  </a>
                </li>
                <li className="header__notify-item">
                  <a href className="header__notify-link">
                    <img src="https://placeimg.com/200/120/tech" alt="" className="header__notify-img" />
                    <div className="header__notify-info">
                      <span className="header__notify-name">Sale Sốc bộ dưỡng Ohui The First Tái tạo trẻ hóa da
                        SALE OFF 70%</span>
                      <span className="header__notify-description">Siêu sale duy nhất 3 ngày 11-13/12/2019</span>
                    </div>
                  </a>
                </li>
              </ul>
        ...
        <li class="header__navbar-item header__navbar-item--strong">
          ...
          <li className="header__navbar-item header__navbar-user">
            <img src="./assets/img/user_avatar.png" alt="" className="header__navbar-user-img" />
        ...
        <div className="header__cart">
          <div className="header__cart-wrap">
            ...
            <div className="header__cart-list ">
              {/* Nocart */}
              <img src="./assets/img/no-cart.png" alt="No Cart" className="header__cart-no-cart-img" />
              ...
              <ul className="header__cart-list-item">
                <li className="header__cart-item">
                  <img src="https://placeimg.com/320/120/tech" alt="" className="header__cart-img" />
                ...
                <li className="header__cart-item">
                  ...
                  <div className="header__cart-item-info">
                    <div className="header__cart-item-head">
                      ...
                      <div className="header__cart-item-price-wrap">
                        <span className="header__cart-item-price">3.105.000đ
                        </span>
                        <span className="header__cart-item-multiply">x</span>
                    ...
                    <div className="header__cart-item-body">
                      <span className="header__cart-item-description">Phân loại : mức</span>
                      <span className="header__cart-item-remove">Xóa</span>
                    </div>
                  </div>
                </li>
                <li className="header__cart-item">
                  ...
                  <div className="header__cart-item-info">
                    <div className="header__cart-item-head">
                      ...
                      <div className="header__cart-item-price-wrap">
                        <span className="header__cart-item-price">11.610.000đ
                        </span>
                        <span className="header__cart-item-multiply">x</span>
                    ...
                    <div className="header__cart-item-body">
                      <span className="header__cart-item-description">Phân loại : Tinh hoa
                      </span>
                      <span className="header__cart-item-remove">Xóa</span>
                    </div>
                  </div>
                ...
                <li className="header__cart-item">
                  ...
                  <div className="header__cart-item-info">
                    <div className="header__cart-item-head">
                      <h5 className="header__cart-item-name">
                        Set dĩa nhôm 7075 39T cho Raider FI
                      </h5>
                      <div className="header__cart-item-price-wrap">
                        <span className="header__cart-item-price">2.000.000đ</span>
                        <span className="header__cart-item-multiply">x</span>
